...
<?php
    $auto = $conn->prepare("SELECT * FROM waggie");
    $auto->execute();
    $autos = $auto->fetchAll(PDO::FETCH_ASSOC);
?>
    <header>
        <div class="advertorials">
            <div class="advertorial">
    ...
    <div class="cars">
        <?php foreach ($autos as $auto) : ?>
            <div class="car-details">
                ...
                <img src="assets/images/<?= $auto['afbeelding'];?>" alt="">
                <div class="car-specification">
                    <span><img src="assets/images/icons/gas-station.svg" alt=""><?= $auto['benzine'];?></span>
                    <span><img src="assets/images/icons/car.svg" alt=""><?= $auto['schakel'];?></span>
                    <span><img src="assets/images/icons/profile-2user.svg" alt=""><?= $auto['capacity'];?></span>
                </div>
                <div class="rent-details">
                    <span><span class="font-weight-bold"><?= $auto['prijs'];?></span> / dag</span>
                    <a href="/car-detail" class="button-primary">Bekijk nu</a>
                </div>
            </div>
        <?php endforeach ?>
